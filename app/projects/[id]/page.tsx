    ...
    return (
        <main className="flex flex-col items-center justify-between overflow-x-clip">
            <div className="w-screen relative flex flex-col">
                ...
                {
                    access ? (
                        <section className="w-[100%] h-fit min-h-[70vh] relative justify-center items-start pt-[60px] lg:mx-auto flex flex-col lg:flex-row">
                            <section
                                className={`transition-[width] ease-in-out z-0 overflow-hidden flex ${sidebarIsOpen ? 'lg:w-[25vw]' : 'w-0 '}`}
                                onMouseEnter={() => setisHovered(true)}
                                onMouseLeave={() => setisHovered(false)}
                            >
                                <article className="lg:w-[20vw] flex flex-col flex-shrink-0 justify-start items-start ml-8 py-4 lg:py-0 px-20 lg:p-4 border rounded-lg lg:border-none lg:rounded-none">
                                    <ul className="h-fit flex-col justify-start items-start inline-flex mb-4 mt-2">
                            ...
                            <div
                                className={`w-[5vw] self-stretch z-1 justify-center items-start hidden lg:flex ${isHovered ? "opacity-100 lg:shadow-[rgba(0,0,0,0.2)_1px_0px_2px_-1px]" : sidebarIsOpen ? "opacity-0" : "opacity-100 lg:shadow-[rgba(0,0,0,0.2)_1px_0px_2px_-1px]"} transition-[opacity,_box-shadow] ease-in-out`}
                                onMouseEnter={() => setisHovered(true)}
                                onMouseLeave={() => setisHovered(false)}
                            >
                                <button className="w-8 h-8 hover:bg-orange-100 mt-4 rounded-lg mx-2" onClick={() => setSidebarIsOpen(!sidebarIsOpen)}>
                            ...
                            <article className={`transition-[width] ease-in-out mx-2 ${sidebarIsOpen ? "lg:w-[70vw]" : "lg:w-[95vw]"} w-fit flex flex-col justify-center items-center`}>
                                ...
                                <section className="w-[90%] flex-col justify-start items-start flex gap-6 my-4">
                                    ...
                                    <article className="w-full aspect-[11/9] flex flex-col gap-4 lg:gap-6">
                                        <div className="w-full justify-start items-stretch gap-4 lg:gap-6 inline-flex">
                                            <div className="w-[63%] aspect-[17/12] bg-zinc-300" />
                                            <div className="w-[37%] aspect-[14/17] bg-zinc-300" />
                                        </div>
                                        <div className="w-full justify-start items-stretch gap-4 lg:gap-6 inline-flex">
                                            <div className="w-[50%] aspect-[7/5] bg-zinc-300" />
                                            <div className="w-[50%] aspect-[7/5] bg-zinc-300" />
                                        </div>
                                    </article>
                                </section>
