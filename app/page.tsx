  ...
  return (
    <main className="flex flex-col items-center justify-between overflow-x-clip">
      <div className="w-screen relative flex flex-col">
        ...
        <section className="w-full h-fit mt-16 relative border-t border-neutral-400 flex flex-col justify-start">
        ...
        <footer className="w-full h-fit relative flex bg-white mt-8">
          <section className="w-[40%] h-[40%] flex flex-col items-start my-4 ml-[10%]">
            <article>
              <h1 className="text-black text-2xl leading-6 mb-2 lg:text-4xl lg:leading-6 font-normal font-['Junicode']">
                Thanks for visiting!
              </h1>
              <p className="text-black text-xs lg:text-base font-normal font-['Epilogue']">
                Stop by and say hi!
              </p>
            </article>
          </section>
