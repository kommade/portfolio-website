  ...
  return (
    <main className="flex flex-col items-center justify-between overflow-x-clip">
      <div className="w-screen relative flex flex-col">
        ...
        <div className="w-full h-[656px] mt-16 relative border-t border-neutral-400 flex flex-col justify-start">
          <div className="text-center grid-title">
            About Me
          </div>
          <div className="info-container flex justify-center">
            <div className="photo-competencies flex flex-col mr-4">
              ...
              <div className="justify-between">
                <span className="about-list font-semibold">
                  COMPETENCIES<br />
                </span>
            ...
            <div className="w-[35%] h-full p-4 bg-white flex flex-col justify-between">
              ...
              <div className="w-[60%] h-[10%] items-end inline-flex mt-4 mb-[5%] ml-auto mr-[5%] justify-between max-w-[145px] gap-[10%]">
                ...
                <a href="https://www.instagram.com/JUEKO_/">
                  <Image
                ...
                <a href="https://www.linkedin.com/in/juliette-khoo/">
                  <Image
